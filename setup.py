...
with open("rio_gsidem/__init__.py") as f:
    for line in f:
...
setup(name="rio-gsidem",
      version=version,
      description=u"Encode arbitrary bit depth rasters in pseudo base-256 as GSI DEM RGB",
      long_description=long_description,
      classifiers=[],
      keywords="",
      author=u"Taro Matsuzawa",
      author_email="btm@tech.email.ne.jp",
      url="https://github.com/smellman/rio-gsidem",
      license="BSD",
      ...
      gsidem=rio_gsidem.scripts.cli:gsidem
      """)
